...
export class MapData extends AbstractTreeNodeData implements IMapData {
	...
	constructor(
		...
		this.#image = image;
		this.#asData =
			properties && properties.asData !== undefined
				? properties.asData
				: false;
		this.#data = properties ? properties.data : undefined;
		this.#blob = properties ? properties.blob : undefined;
		this.#wrapS =
			properties && properties.wrapS !== undefined
				? properties.wrapS
				: TEXTURE_WRAPPING.REPEAT;
		this.#wrapT =
			properties && properties.wrapT !== undefined
				? properties.wrapT
				: TEXTURE_WRAPPING.REPEAT;
		this.#minFilter =
			properties && properties.minFilter !== undefined
				? properties.minFilter
				: TEXTURE_FILTERING.NONE;
		this.#magFilter =
			properties && properties.magFilter !== undefined
				? properties.magFilter
				: TEXTURE_FILTERING.NONE;
		this.#center =
			properties && properties.center !== undefined
				? properties.center
				: vec2.fromValues(0, 0);
		this.#color = properties ? properties.color : undefined;
		this.#offset =
			properties && properties.offset !== undefined
				? properties.offset
				: vec2.fromValues(0, 0);
		this.#repeat =
			properties && properties.repeat !== undefined
				? properties.repeat
				: vec2.fromValues(1, 1);
		this.#rotation =
		...
		this.#flipY =
			properties && properties.flipY !== undefined
				? properties.flipY
				: true;
	}
