...
export class SystemInfo {
    ...
    private readonly _runningInSafari: boolean;
    ...
    constructor() {
        ...
        this._runningInSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
        ...
        this._isMobileDevice = (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) 
     ...
     */
    public get runningInSafari(): boolean {
        return this._runningInSafari;
    };
