...
export class ShapeDiverViewerEnvironmentMapError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while loading the environment map.",
			message,
		);
	}
}
...
export class ShapeDiverViewerWebGLError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred regarding to the WebGL context.",
			message,
		);
	}
}
...
export class ShapeDiverViewerSessionError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while working with the session.",
			message,
		);
	}
}
...
export class ShapeDiverViewerCustomizationError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while customizing the session.",
			message,
		);
	}
}
...
export class ShapeDiverViewerViewportError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while working with the viewport.",
			message,
		);
	}
}
...
export class ShapeDiverViewerLightError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while working with the lights.",
			message,
		);
	}
}
...
export class ShapeDiverViewerCameraError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while working with the cameras.",
			message,
		);
	}
}
...
export class ShapeDiverViewerArError extends ShapeDiverViewerError {
	constructor(
		...
		super(
			...
			"An error occurred while working with AR.",
			message,
		);
	}
}
...
export class ShapeDiverViewerInteractionError extends ShapeDiverViewerError {
	constructor(public readonly message: string) {
		super(
			...
			"An error occurred with interactions.",
			message,
		);
	}
}
...
export class ShapeDiverViewerDrawingToolsError extends ShapeDiverViewerError {
	constructor(public readonly message: string) {
		super(
			ShapeDiverViewerErrorType.INTERACTION_ERROR,
			"An error occurred with drawing tools.",
			message,
		);
	}
}
