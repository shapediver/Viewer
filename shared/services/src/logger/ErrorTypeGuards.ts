...
export function isViewerCustomizationError(e: any): e is ShapeDiverViewerCustomizationError {
    return e instanceof Error &&
        'errorType' in e &&
        (<ShapeDiverViewerError>e).errorType === ShapeDiverViewerErrorType.CUSTOMIZATION_ERROR;
}
