...
export class Stage {
	...
	constructor(
		name: string,
		icon: string,
		onStartCallback: (data: IStageData) => Promise<void>,
		onEndCallback: (data: IStageData) => Promise<void>,
		onRevertCallback: (data: IStageData) => Promise<void>,
	) {
		this.name = name;
...
export class StageManager {
	...
	constructor(stages: Stage[], stagesDiv: HTMLDivElement) {
		...
		goForwardImg.src =
			"https://shapediverviewer.s3.amazonaws.com/v3/graphics/arrow-right-circle-outline.svg";
		goForwardImg.onclick = () => {
			this.goForward();
		};
		...
		goBackwardImg.src =
			"https://shapediverviewer.s3.amazonaws.com/v3/graphics/arrow-left-circle-outline.svg";
		goBackwardImg.onclick = () => {
			this.goBackward();
		};
	...
	async start() {
		...
		arrowImage.src =
			"https://shapediverviewer.s3.amazonaws.com/v3/graphics/arrow-right-thin.svg";
