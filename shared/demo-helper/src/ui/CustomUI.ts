  ...
  export const createCustomUi = (
    ...
    for (let i = 0; i < elements.length; i++) {
      ...
      if (menuElement.type === "slider") {
        ...
        // the value input
        const valueInputElement = document.createElement("input") as HTMLInputElement;
        valueInputElement.classList.value = "mt-2 text-sm font-medium text-gray-900 dark:text-gray-300";
        ...
        // the slider
        const sliderInputElement = document.createElement("input") as HTMLInputElement;
        ...
        // the toggle
        const booleanInputElement = document.createElement("input") as HTMLInputElement;
        booleanInputElement.classList.value = "ml-2 mb-2 mt-2 w-4 h-4 text-gray-600 bg-gray-100 rounded border-gray-300 focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"; 
        ...
        booleanInputElement.onchange = async () => {
          if (menuElement.onChangeCallback) menuElement.onChangeCallback(booleanInputElement.checked);
          if (menuElement.onInputCallback) menuElement.onInputCallback(booleanInputElement.checked);
        };
        ...
        // the dropdown
        const dropdownInputElement = document.createElement("select") as HTMLSelectElement;
        ...
        dropdownInputElement.onchange = () => {
          if (menuElement.onChangeCallback) menuElement.onChangeCallback(dropdownInputElement.value);
          if (menuElement.onInputCallback) menuElement.onInputCallback(dropdownInputElement.value);
        };
