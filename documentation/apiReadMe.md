...
(async () => {
  // create a viewer
  const viewer = <IStandardViewer>await api.createViewer({ canvas: <HTMLCanvasElement>document.getElementById('canvas'), id: 'myViewer' });
  // create a session
...
## Version
* __Version:__ 1.4.4
* __Build date:__ 2021-10-06T10:03:32.003Z
* __Branch:__ development
* __Commit:__ 484835dd4f4ceeb044239f4ae2fc0ce74ef1eff1
<!--- VERSION_END -->