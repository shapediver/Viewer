...
import {
	convertFromPrevious as CFPv2,
	convertToPrevious as CTPv2,
} from "../src/versions/v2/Converter";
import {
	convertFromPrevious as CFPv3,
	convertToPrevious as CTPv3,
} from "../src/versions/v3/Converter";
import {
	convertFromPrevious as CFPv3_1,
	convertToPrevious as CTPv3_1,
} from "../src/versions/v3_1/Converter";
...
describe("conversion - V3", () => {
	it("convertFrom - equal", async () => {
		...
		expect(
			converted.camera.cameras[converted.camera.cameraId],
		).not.toBeUndefined(); // camera conversion
