...
describe('validationV1', () => {
    it('validate - defaults', async () => {
        ...
        expect(() => { validateV1(defaultsV1) }).not.toThrowError();
    });
})
...
describe('validationV2', () => {
    it('validate - defaults', async () => {
        ...
        expect(() => { validateV2(defaultsV2) }).not.toThrowError();
    });

    it('validate - empty', async () => {
        expect(() => { validateV2({}) }).toThrowError();
    });

    it('validate - malicious', async () => {
        const defaultsV2 = DefaultsV2();
        (<any>defaultsV2).maliciousFunction = () => { console.log('I am bad!') };
        expect(() => { validateV2(defaultsV2) }).toThrowError();
    });
...
describe('validationV3', () => {
    it('validate - defaults', async () => {
        ...
        expect(() => { validateV3(defaultsV3) }).not.toThrowError();
    });

    it('validate - empty', async () => {
        expect(() => { validateV3({}) }).toThrowError();
    });

    it('validate - malicious', async () => {
        const defaultsV3 = DefaultsV3();
        (<any>defaultsV3).maliciousFunction = () => { console.log('I am bad!') };
        expect(() => { validateV3(defaultsV3) }).toThrowError();
    });
    ...
    it('validate - real cameras', async () => {
        ...
        (<any>defaultsV3.camera).cameras = {
            'e6c08e7f-b2ef-474f-9bba-31821e272535': {
                ...
                fov: 45,
                position: {x: 58.03696060180664, y: -290.11590576171875, z: 87.67756652832031},
...
describe('validationV3.1', () => {
    it('validate - defaults', async () => {
        ...
        expect(() => { validateV3_1(defaultsV3_1) }).not.toThrowError();
    });

    it('validate - empty', async () => {
        expect(() => { validateV3_1({}) }).toThrowError();
    });

    it('validate - malicious', async () => {
        const defaultsV3_1 = DefaultsV3_1();
        (<any>defaultsV3_1).maliciousFunction = () => { console.log('I am bad!') };
        expect(() => { validateV3_1(defaultsV3_1) }).toThrowError();
    });
    ...
    it('validate - real light scene', async () => {
        ...
        expect(() => { validate(obj) }).not.toThrowError();
    });
