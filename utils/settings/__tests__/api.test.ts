...
describe('conversion', () => {
    ...
    it('convertFrom - equal 3', async () => {
        ...
        expect(JSON.stringify(converted)).toStrictEqual(JSON.stringify(defaultsV3_2));
    });
    ...
    it('convertFrom - not equal', async () => {
        ...
        const converted = convert(defaultsV3_1, '3.2');
        expect(JSON.stringify(converted)).not.toStrictEqual(JSON.stringify(defaultsV3_2));
    });
    ...
    it('convertFrom - equal 3', async () => {
        ...
        expect(JSON.stringify(converted)).toStrictEqual(JSON.stringify(defaultsV3_3));
    });
    ...
    it('convertFrom - not equal', async () => {
        ...
        const converted = convert(defaultsV3_2, '3.3');
        (<any>converted).rendering.automaticColorAdjustment = true;
        expect(JSON.stringify(converted)).not.toStrictEqual(JSON.stringify(defaultsV3_3));
    });
    ...
    it('convertFrom - equal 3', async () => {
        ...
        expect((<any>converted).environment.rotation).toStrictEqual({ x: 0, y: 0, z: 0, w: 1 });
        (<any>converted).environment.rotation = { x: 0, y: 0, z: 0, w: 1 };
        expect(JSON.stringify(converted)).toStrictEqual(JSON.stringify(defaultsV3_4));
    });
    ...
    it('convertFrom - not equal', async () => {
        ...
        expect(JSON.stringify(converted)).not.toStrictEqual(JSON.stringify(defaultsV3_4));
    });
...
describe('evaluateSettingsVersion', () => {
    it('eval', async () => {
        ...
        const targetVersion29 = evaluateSettingsVersion('3.3.8.0'); // results in '6.0'
        expect(targetVersion29).toBe('6.0');
    });
});
...
describe('validation', () => {
    it('validate - defaults', async () => {
        const defaultsV1 = DefaultsV1();
        expect(() => { validate(defaultsV1) }).not.toThrowError();
    });

    it('validate - wrong defaults 1', async () => {
        const defaultsV1 = DefaultsV1();
        expect(() => { validate(defaultsV1, '2.0') }).toThrowError();
    });

    it('validate - wrong defaults 2', async () => {
        const defaultsV1 = DefaultsV1();
        expect(() => { validate(defaultsV1, '3.0') }).toThrowError();
    });

    it('validate - wrong defaults 3', async () => {
        const defaultsV2 = DefaultsV2();
        expect(() => { validate(defaultsV2, '1.0') }).toThrowError();
    });

    it('validate - wrong defaults 4', async () => {
        const defaultsV2 = DefaultsV2();
        expect(() => { validate(defaultsV2, '3.0') }).toThrowError();
    });

    it('validate - wrong defaults 5', async () => {
        const defaultsV3 = DefaultsV3();
        expect(() => { validate(defaultsV3, '1.0') }).toThrowError();
    });

    it('validate - wrong defaults 6', async () => {
        const defaultsV3 = DefaultsV3();
        expect(() => { validate(defaultsV3, '2.0') }).toThrowError();
    });

    it('validate - defaults', async () => {
        const defaultsV2 = DefaultsV2();
        expect(() => { validate(defaultsV2) }).not.toThrowError();
    });
    
    it('validate - malicious', async () => {
        const defaultsV2 = DefaultsV2();
        (<any>defaultsV2).maliciousFunction = () => { console.log('I am bad!') };
        expect(() => { validate(defaultsV2) }).toThrowError();
    });
    ...
    it('validate - defaults', async () => {
        const defaultsV3 = DefaultsV3();
        expect(() => { validate(defaultsV3) }).not.toThrowError();
    });

    it('validate - defaults 2', async () => {
        const defaultsV3 = DefaultsV3();
        expect(() => { validate(defaultsV3, '3.0') }).not.toThrowError();
    });

    it('validate - missing', async () => {
        const defaultsV3 = DefaultsV3();
        delete (<any>defaultsV3.rendering).ambientOcclusion;
        expect(() => { validate(defaultsV3) }).toThrowError();
    });
