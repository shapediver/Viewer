...
const schema = z.object({
    ...
    camera: z.object({ position: z.object({ x: z.number().optional(), y: z.number().optional(), z: z.number().optional() }).optional(), target: z.object({ x: z.number().optional(), y: z.number().optional(), z: z.number().optional() }).optional() }).optional(),
    cameraAutoAdjust: z.boolean().optional(),
    cameraMovementDuration: z.number().optional(),
    cameraOrtho: z.object({ position: z.object({ x: z.number().optional(), y: z.number().optional(), z: z.number().optional() }).optional(), target: z.object({ x: z.number().optional(), y: z.number().optional(), z: z.number().optional() }).optional() }).optional(),
    ...
    defaultMaterialColor: z.union([z.string(), z.number().array().optional()]),
