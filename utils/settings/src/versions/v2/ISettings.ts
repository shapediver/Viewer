    ...
    viewer: {
        ...
        scene: {
            ...
            camera: {
                ...
                cameraTypes: {
                    perspective: {
                        default: { position: { x: number, y: number, z: number }, target: { x: number, y: number, z: number } },
                        fov: number,
                        controls: number,
                    },
                    orthographic: {
                ...
                controls: {
                    orbit: {
                        ...
                        restrictions: {
                            position?: {
                                cube?: { min: { x: number, y: number, z: number }, max: { x: number, y: number, z: number } },
                            ...
                            rotation?: { minPolarAngle: number, maxPolarAngle: number, minAzimuthAngle: number, maxAzimuthAngle: number },
