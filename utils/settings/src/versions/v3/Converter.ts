...
import { v4 } from "uuid";
import { IOrthographicCameraSettings, IPerspectiveCameraSettings } from "./ICameraSettings";
import { IAmbientLightProperties, IDirectionalLightProperties, IHemisphereLightProperties, IPointLightProperties, ISpotLightProperties } from "./ILightSceneSettings";
...
export const convertFromPrevious = (s: IGlobalSettings, v: versions): IGlobalSettings => {
    ...
    if(oldSettings.viewer.showMessages) settings.general.showMessages = oldSettings.viewer.showMessages;
                ...
                switch (l.type) {
                    case 'ambient':
                        lights[lightId] = {
                            ...
                            type: l.type,
                            properties: {
                                color: (<IAmbientLightProperties>l.properties).color,
                    ...
                    case 'directional':
                        lights[lightId] = {
                            ...
                            type: l.type,
                            properties: {
                                direction: { x: (<IDirectionalLightProperties>l.properties).direction.x, y: (<IDirectionalLightProperties>l.properties).direction.y, z: (<IDirectionalLightProperties>l.properties).direction.z },
                                color: (<IDirectionalLightProperties>l.properties).color,
                                intensity: l.properties.intensity,
                                castShadow: (<IDirectionalLightProperties>l.properties).castShadow,
                                shadowMapResolution: (<IDirectionalLightProperties>l.properties).shadowMapResolution,
                                shadowMapBias: (<IDirectionalLightProperties>l.properties).shadowMapBias,
                            }
                        }
                        break;
                    case 'hemisphere':
                        lights[lightId] = {
                            ...
                            type: l.type,
                            properties: {
                                skyColor: (<IHemisphereLightProperties>l.properties).skyColor,
                                intensity: l.properties.intensity,
                                groundColor: (<IHemisphereLightProperties>l.properties).groundColor,
                            }
                        }
                        break;
                    case 'point':
                        lights[lightId] = {
                            ...
                            properties: {
                                ...
                                intensity: l.properties.intensity,
                                position: { x: (<IPointLightProperties>l.properties).position.x, y: (<IPointLightProperties>l.properties).position.y, z: (<IPointLightProperties>l.properties).position.z },
                                distance: (<IPointLightProperties>l.properties).distance,
                    ...
                    case 'spot':
                        lights[lightId] = {
                            ...
                            properties: {
                                ...
                                intensity: l.properties.intensity,
                                position: { x: (<ISpotLightProperties>l.properties).position.x, y: (<ISpotLightProperties>l.properties).position.y, z: (<ISpotLightProperties>l.properties).position.z },
                                target: { x: (<ISpotLightProperties>l.properties).target.x, y: (<ISpotLightProperties>l.properties).target.y, z: (<ISpotLightProperties>l.properties).target.z },
                                distance: (<ISpotLightProperties>l.properties).distance,
                                decay: (<ISpotLightProperties>l.properties).decay,
                                angle: (<ISpotLightProperties>l.properties).angle,
                                penumbra: (<ISpotLightProperties>l.properties).penumbra,
                            }
                        }
                        break;
                }
    ...
    if(oldSettings.viewer.scene.render.beautyRenderBlendingDuration !== undefined) settings.rendering.beautyRenderBlendingDuration = oldSettings.viewer.scene.render.beautyRenderBlendingDuration;
