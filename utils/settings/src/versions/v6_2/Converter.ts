...
export const convertFromPrevious = (
	...
	const settings: ISettingsV6_2 = {
		...
		light: {
			lightSceneId: oldSettings.light.lightSceneId,
			loadDefaultLights: true,
			lightScenes: oldSettings.light.lightScenes,
		},
...
export const convertToPrevious = (
	...
	const settings = {
		...
		light: {
			lightSceneId: newSettings.light.lightSceneId,
			lightScenes: newSettings.light.lightScenes,
		},
