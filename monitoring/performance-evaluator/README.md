# `viewer.monitoring.performance-evaluator`

> This package provides performance evaluation functionality for the viewer.

## Install
```
npm install @shapediver/viewer.monitoring.performance-evaluator
```
...
import { PerformanceEvaluator } from '@shapediver/viewer.monitoring.performance-evaluator';
