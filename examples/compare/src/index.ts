...
(async () => {
    document.getElementById('submitButton')!.onclick = () => {
        const ticket = (<HTMLTextAreaElement>document.getElementById('ticket')).textContent;
        const modelViewUrl = (<HTMLTextAreaElement>document.getElementById('modelViewUrl')).textContent;
    ...
    // const initSdvApp = function (/*event*/) {
    //     (<any>window).api = new (<any>window).SDVApp.ParametricViewer({ container: document.getElementById('sdv-container'), ticket, modelViewUrl, showControlsInitial: false, showSettingsInitial: false });
    // };
