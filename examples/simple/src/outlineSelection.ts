...
import { InteractionEngine, SelectManager, InteractionData, IDragEvent } from '@shapediver/viewer.features.interaction';
...
(async () => {
    ...
    addListener(SDV.EVENTTYPE.INTERACTION.SELECT_ON, (e) => {
        ...
        viewport.postProcessing.outlineEffects[outlineEffectToken].addSelection(dragEvent.node);
    })
