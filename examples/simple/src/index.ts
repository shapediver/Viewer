...
import { api, Viewer } from "@shapediver/viewer"
...
(async () => {
    let viewer = await api.createViewer(RENDERERTYPE.THREEJS, <HTMLCanvasElement>document.getElementById('canvas'), 'myViewer')
