...
import { api } from "@shapediver/viewer.headless"
...
http.createServer().listen(8000, 'localhost', async () => {
    const { ticket, modelViewUrl } = models['Shelf'];
    let session = await api.createSession({ 
        ticket: 'e86502b7d8fe0f90a68ed9a3c0d928081930db87feefeafa9a0fa07f1b452130acd4f2935fd6263b26450f7160a939ecd13f40608923378cdf8fcdf134137d92df8e4d1944dfcb35ed541b43f5771b7b1a3e93862c68d970b6ac80fffa9b67d69e4c20e70315d507463194081a6f1d95af26f882a2bde243-da6d759873dee7a9004e3cfd055ea3af', 
        modelViewUrl, id: 'mySession'});
});