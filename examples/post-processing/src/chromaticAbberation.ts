		...
		[
			<IDropdownElement>{
				...
				value: Object.values(BlendFunction).indexOf(
					chromaticAberrationEffectDefinition.properties!
						.blendFunction!,
				),
			},
			<IBooleanElement>{
				...
				onChangeCallback: (value: boolean) => {
					chromaticAberrationEffectDefinition.properties!.radialModulation =
						value;
					viewport.postProcessing.updateEffect(
						chromaticAberrationEffectToken,
						chromaticAberrationEffectDefinition,
				...
				value: chromaticAberrationEffectDefinition.properties!
					.radialModulation,
			},
			<ISliderElement>{
				name: "offset - x",
			...
			<ISliderElement>{
				...
				type: "slider",
				onChangeCallback: (value: number) => {
					chromaticAberrationEffectDefinition.properties!.modulationOffset =
						value;
					viewport.postProcessing.updateEffect(
						chromaticAberrationEffectToken,
						chromaticAberrationEffectDefinition,
