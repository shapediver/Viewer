...
(async () => {
  ...
  const session1 = await createSession({
    ticket:
      "2cda4f5fc595066965ee34e9577b32dbd49e9938ec965bb72aa078e1e59822d2a8420c14e7aca9142c5859e25eebcd9078fa0e798848d88193d740de047092448a950f770e8aed4b451027bd4b7875b64bda753b7c21be13022f3d2edcf3f15fdd519f117e42d3-9298c5dcbebb67e460904215807c8184",
  ...
  session2.node.addTransformation({
    id: "scale",
    matrix: mat4.fromScaling(mat4.create(), vec3.fromValues(0.001, 0.001, 0.001))
  })
  ...
  SDV.viewports["myViewport1"].postProcessing.addEffect({
    properties: {
      resolutionScale: 1, spp: 8, distance: 1, distanceIntensity: 0.5, intensity: 10, color: "#000000",
