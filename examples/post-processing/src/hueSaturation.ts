	...
	createCustomUi(
		[
			...
			<ISliderElement>{
				...
				type: "slider",
				onChangeCallback: (value: number) => {
					hueSaturationEffectDefinition.properties!.saturation =
						value;
					viewport.postProcessing.updateEffect(
						hueSaturationEffectToken,
						hueSaturationEffectDefinition,
