		...
		[
			<IDropdownElement>{
				...
				onChangeCallback: (value: string) => {
					selectiveBloomEffectDefinition.properties!.blendFunction =
						Object.values(BlendFunction)[+value] as BlendFunction;
			...
			<IBooleanElement>{
				...
				onChangeCallback: (value: boolean) => {
					selectiveBloomEffectDefinition.properties!.mipmapBlur =
						value;
					viewport.postProcessing.updateEffect(
						selectiveBloomEffectToken,
						selectiveBloomEffectDefinition,
			...
			<IBooleanElement>{
				...
				onChangeCallback: (value: any) => {
					selectiveBloomEffectDefinition.properties!.ignoreBackground =
						value;
					viewport.postProcessing.updateEffect(
						selectiveBloomEffectToken,
						selectiveBloomEffectDefinition,
				...
				value: selectiveBloomEffectDefinition.properties!
					.ignoreBackground,
			},
			<ISliderElement>{
				name: "intensity",
				...
				onChangeCallback: (value: number) => {
					selectiveBloomEffectDefinition.properties!.intensity =
						value;
					viewport.postProcessing.updateEffect(
						selectiveBloomEffectToken,
						selectiveBloomEffectDefinition,
			...
			<ISliderElement>{
				...
				type: "slider",
				onChangeCallback: (value: number) => {
					selectiveBloomEffectDefinition.properties!.luminanceSmoothing =
						value;
					viewport.postProcessing.updateEffect(
						selectiveBloomEffectToken,
						selectiveBloomEffectDefinition,
			...
			<ISliderElement>{
				...
				type: "slider",
				onChangeCallback: (value: number) => {
					selectiveBloomEffectDefinition.properties!.luminanceThreshold =
						value;
					viewport.postProcessing.updateEffect(
						selectiveBloomEffectToken,
						selectiveBloomEffectDefinition,
			...
			<IDropdownElement>{
				...
				type: "dropdown",
				onChangeCallback: (value: number) => {
					selectiveBloomEffectDefinition.properties!.kernelSize =
						value;
					viewport.postProcessing.updateEffect(
						selectiveBloomEffectToken,
						selectiveBloomEffectDefinition,
