		...
		[
			<IDropdownElement>{
				...
				onChangeCallback: (value: string) => {
					vignetteEffectDefinition.properties!.blendFunction =
			...
			<IDropdownElement>{
				...
				type: "dropdown",
				onChangeCallback: (value: string) => {
					vignetteEffectDefinition.properties!.technique =
						Object.values(VignetteTechnique)[
							+value
						] as VignetteTechnique;
					viewport.postProcessing.updateEffect(
						vignetteEffectToken,
						vignetteEffectDefinition,
					);
				...
				value: Object.values(VignetteTechnique).indexOf(
					vignetteEffectDefinition.properties!.technique!,
				),
			},
		],
