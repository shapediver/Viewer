...
class GeneralOptions {
	...
	public set parallelGlTFProcessing(value: number) {
		...
		logger.debug(
			`parallelGlTFProcessing: ParallelGlTFProcessing was set to: ${value}`,
		);
	}
...
let createdConsoleMessage = false,
	consoleBranding = true;
/**
