...
(async () => {
    api.createViewer({ canvas: <HTMLCanvasElement>document.getElementById('canvas') })
...
const viewer = api.createViewer({ canvas: CANVAS, id: 'myViewer' });
```
...
<!--- VERSION_START -->
## Version
* __Version:__ 3.0.2.40
* __Build date:__ 2021-05-04T09:27:25.916Z
* __Branch:__ development
* __Commit:__ f24ca8ed90c5c3ccfe46a0f220d4769e70006868
<!--- VERSION_END -->