...
export class Api implements IApi {
  ...
  constructor() {
    try {
      ...
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.constructor: Api created.`);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.constructor', e);
    }
  }
  ...
  public set automaticUpdate(value: boolean) {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.automaticUpdate: Updating automaticUpdate to ${value}.`);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.GENERAL, 'Api.automaticUpdate', value, 'boolean');
      ...
      this.#logger.debug(LOGGING_TOPIC.GENERAL, `Api.automaticUpdate: automaticUpdate was set to: ${value}`);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.automaticUpdate', e);
    }
  }
  ...
  public set enableAR(value: boolean) {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.enableAR: Updating enableAR to ${value}.`);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.GENERAL, 'Api.enableAR', value, 'boolean');
      this.#settingsEngine.ar.enable = value;
      this.#logger.debug(LOGGING_TOPIC.GENERAL, `Api.enableAR: enableAR was set to: ${value}`);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.enableAR', e);
    }
  }
  ...
  public set globalRotation(value: vec3) {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.globalRotation: Updating globalRotation to ${value}.`);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.GENERAL, 'Api.globalRotation', value, 'vec3');
      this.#settingsEngine.general.transformation.rotation = { x: value[0], y: value[1], z: value[2] };
      this.#logger.debug(LOGGING_TOPIC.GENERAL, `Api.globalRotation: globalRotation was set to: ${value}`);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.globalRotation', e);
    }
  }
  ...
  public set globalScale(value: vec3) {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.globalScale: Updating globalScale to ${value}.`);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.GENERAL, 'Api.globalScale', value, 'vec3');
      this.#settingsEngine.general.transformation.scale = { x: value[0], y: value[1], z: value[2] };
      this.#logger.debug(LOGGING_TOPIC.GENERAL, `Api.globalScale: globalScale was set to: ${value}`);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.globalScale', e);
    }
  }
  ...
  public set globalTranslation(value: vec3) {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.globalTranslation: Updating globalTranslation to ${value}.`);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.GENERAL, 'Api.globalTranslation', value, 'vec3');
      this.#settingsEngine.general.transformation.translation = { x: value[0], y: value[1], z: value[2] };
      this.#logger.debug(LOGGING_TOPIC.GENERAL, `Api.globalTranslation: globalTranslation was set to: ${value}`);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.globalTranslation', e);
    }
  }
  ...
  public addListener(type: string | MainEventTypes, cb: (event: IEvent) => void): string {
    try {
      ...
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.addListener', e);
    }
  }
  ...
  public async applySettings(
    ...
    try {
      ...
      if ((<ShapeDiverResponseDto>response).viewer !== undefined) {
        ...
        throw this.#logger.handleError(LOGGING_TOPIC.SETTINGS, 'Api.applySettings', error);
      }
      ...
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.applySettings', e);
    }
  }
  ...
  public async convertSceneToGLTF(convertForAR = false): Promise<Blob> {
    try {
      ...
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.convertSceneToGLTF', e);
    }
  }
  ...
  public createSDTFOverview(node: TreeNode = this.sceneTree.root): ISDTFOverview {
    try {
      ...
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.createSDTFOverview', e);
    }
  }
  ...
  public async createSession(properties: { ticket: string, modelViewUrl: string, bearerToken?: string, primarySession?: boolean, id?: string, excludeViewers?: string[], waitForOutputs?: boolean, loadOutputs?: boolean, initialParameters?: { [key: string]: string } }): Promise<ISession> {
    ...
    try {
      ...
      this.#logger.info(LOGGING_TOPIC.SESSION, `Api.createSession: Creating and initializing session with properties ${JSON.stringify(properties)}.`);
      // input validation
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties, 'object');
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.ticket, 'string');
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.modelViewUrl, 'string');
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.bearerToken, 'string', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.primarySession, 'boolean', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.excludeViewers, 'stringArray', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.id, 'string', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.waitForOutputs, 'boolean', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.loadOutputs, 'boolean', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.initialParameters, 'object', false);
      if (properties.initialParameters)
        for (let p in properties.initialParameters)
          this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, `Api.createSession`, properties.initialParameters[p], 'string');
      ...
      if (this.sessions[sessionId]) {
        ...
        this.#logger.warn(LOGGING_TOPIC.SESSION, `Api.createSession: Session with this id (${sessionId}) already exists. Closing initial instance.`);
      ...
      this.#logger.debug(LOGGING_TOPIC.SESSION, `Api.createSession: Session(${session.id}) created.`);
  ...
  public async createViewer(properties?: { visibility?: VISIBILITY_MODE, canvas?: HTMLCanvasElement, id?: string, branding?: { logo?: string | null, backgroundColor?: string } }): Promise<IViewer> {
    let viewerId: string = '';
    const eventId = this.#uuidGenerator.create();
    try {
      ...
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, 'Api.createViewer', properties, 'object', false);
      const prop = Object.assign({}, properties);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, `Api.createViewer`, prop.visibility, 'enum', false, Object.values(VISIBILITY_MODE));
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, `Api.createViewer`, prop.canvas, 'HTMLCanvasElement', false);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, `Api.createViewer`, prop.id, 'string', false);

      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, 'Api.createViewer', prop.branding, 'object', false);
      const branding = Object.assign({}, prop.branding);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, `Api.createViewer`, branding.backgroundColor, 'string', false);
      ...
      if (this.viewers[viewerId]) {
        ...
        this.#logger.warn(LOGGING_TOPIC.SESSION, `Api.createViewer: Viewer with this id (${viewerId}) already exists. Closing initial instance.`);
      ...
      let viewer: IViewer = new Viewer({
        id: viewerId,
        canvas: prop.canvas,
        visibility: prop.visibility || VISIBILITY_MODE.SESSION,
        branding: {
      ...
      this.#logger.debug(LOGGING_TOPIC.VIEWER, `Api.createViewer: Viewer(${viewer.id}) created.`);
  ...
  public removeListener(id: string): boolean {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.GENERAL, `Api.removeListener: Removing event listener with id ${id}.`);
      return this.#eventEngine.removeListener(id);
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.removeListener', e);
    }
  }

  public update(): void {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.VIEWER, `Api.update: Updating all viewers.`);
      for (let v in this.viewers)
        this.viewers[v].update();
    } catch (e) {
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.update', e);
    }
  }
  ...
  public async viewInAR(options: { arScale?: 'auto' | 'fixed', arPlacement?: 'floor' | 'wall', xrEnvironment?: boolean } = { arScale: 'auto', arPlacement: 'floor', xrEnvironment: false }): Promise<void> {
    ...
    try {
      ...
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, 'Api.viewInAR', options, 'object', false);
  ...
  public viewableInAR(): boolean {
    try {
      ...
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.viewableInAR', e);
    }
  }
  ...
  private async _closeSession(id: string, force = false): Promise<boolean> {
    try {
      ...
      this.#inputValidator.validateAndError(LOGGING_TOPIC.SESSION, 'Api.closeSession', id, 'string');
      if (!this.sessions[id]) {
        this.#logger.warn(LOGGING_TOPIC.SESSION, `Api.closeSession: Session with id ${id} was not registered.`);
        return false;
      }
      ...
      for (let s in this.sessions) {
        ...
        if (session.primarySessionRequest) {
          ...
          this.#logger.debug(LOGGING_TOPIC.SESSION, `Session(${s}): Initializing settings.`);
          break;
        }
      }
  ...
  private async _closeViewer(id: string, force = false): Promise<boolean> {
    try {
      this.#logger.debugLow(LOGGING_TOPIC.VIEWER, `Api.closeViewer: Closing viewer ${id}.`);
      this.#inputValidator.validateAndError(LOGGING_TOPIC.VIEWER, 'Api.closeViewer', id, 'string');
      if (!this.viewers[id]) {
        this.#logger.warn(LOGGING_TOPIC.VIEWER, `Api.closeViewer: Viewer with id ${id} was not registered`);
        return false;
      }
      ...
      if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
      throw this.#logger.handleError(LOGGING_TOPIC.GENERAL, 'Api.closeViewer', e);
    }
  }
