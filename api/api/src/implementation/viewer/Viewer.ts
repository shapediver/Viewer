...
export class Viewer implements IViewer {
  ...
  public set gridColor(value: string | number | vec3) {
    try {
      ...
      this.#logger.info(LOGGINGTOPIC.VIEWER, `Viewer(${this.id}).gridColor: gridColor was set to: ${value}`);
      this.update();
    } catch (e) {
      if (e instanceof SDError) throw e;
      throw this.#logger.error(LOGGINGTOPIC.VIEWER, e, `Viewer(${this.id}).gridColor: Something unexpected happened.`, true)
    }
  }
  ...
  public set groundPlaneColor(value: string | number | vec3) {
    try {
      ...
      this.#logger.info(LOGGINGTOPIC.VIEWER, `Viewer(${this.id}).groundPlaneColor: groundPlaneColor was set to: ${value}`);
      this.update();
    } catch (e) {
      if (e instanceof SDError) throw e;
      throw this.#logger.error(LOGGINGTOPIC.VIEWER, e, `Viewer(${this.id}).groundPlaneColor: Something unexpected happened.`, true)
    }
  }
  ...
  public set outputEncoding(value: TEXTUREENCODING) {
    try {
      ...
      if (e instanceof SDError) throw e;
      throw this.#logger.error(LOGGINGTOPIC.VIEWER, e, `Viewer(${this.id}).outputEncoding: Something unexpected happened.`, true)
    }
  }
  ...
  public set textureEncoding(value: TEXTUREENCODING) {
    try {
      ...
      if (e instanceof SDError) throw e;
      throw this.#logger.error(LOGGINGTOPIC.VIEWER, e, `Viewer(${this.id}).textureEncoding: Something unexpected happened.`, true)
    }
  }
  ...
  public set toneMapping(value: TONEMAPPING) {
    try {
      ...
      if (e instanceof SDError) throw e;
      throw this.#logger.error(LOGGINGTOPIC.VIEWER, e, `Viewer(${this.id}).toneMapping: Something unexpected happened.`, true)
    }
  }
  ...
  public set toneMappingExposure(value: number) {
    try {
      ...
      this.#logger.info(LOGGINGTOPIC.VIEWER, `Viewer(${this.id}).toneMappingExposure: toneMappingExposure was set to: ${value}`);
      this.update();
    } catch (e) {
      if (e instanceof SDError) throw e;
      throw this.#logger.error(LOGGINGTOPIC.VIEWER, e, `Viewer(${this.id}).toneMappingExposure: Something unexpected happened.`, true)
    }
  }
