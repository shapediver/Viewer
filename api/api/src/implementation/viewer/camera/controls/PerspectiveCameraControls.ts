...
export class PerspectiveCameraControls implements IPerspectiveCameraControls {
    ...
    public set autoRotationSpeed(value: number) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).autoRotationSpeed: autoRotationSpeed was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set cubePositionRestriction(value: { min: vec3, max: vec3 }) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).cubePositionRestriction: cubePositionRestriction was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set cubeTargetRestriction(value: { min: vec3, max: vec3 }) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).cubeTargetRestriction: cubeTargetRestriction was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set enableAutoRotation(value: boolean) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).enableAutoRotation: enableAutoRotation was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set enableRotation(value: boolean) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).enableRotation: enableRotation was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set rotationRestriction(value: { minPolarAngle: number, maxPolarAngle: number, minAzimuthAngle: number, maxAzimuthAngle: number }) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).rotationRestriction: rotationRestriction was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set rotationSpeed(value: number) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).rotationSpeed: rotationSpeed was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set spherePositionRestriction(value: { center: vec3, radius: number }) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).spherePositionRestriction: spherePositionRestriction was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set sphereTargetRestriction(value: { center: vec3, radius: number }) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).sphereTargetRestriction: sphereTargetRestriction was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
    ...
    public set zoomRestriction(value: { minDistance: number, maxDistance: number }) {
        try {
            ...
            this.#logger.info(LOGGINGTOPIC.CAMERA_CONTROL, `Controls(${this.#controls.camera.id}).zoomRestriction: zoomRestriction was set to: ${value}`);
            this.#viewer.update();
        } catch (e) {
            if (e instanceof ShapeDiverViewerError || e instanceof ShapeDiverBackendError) throw e;
