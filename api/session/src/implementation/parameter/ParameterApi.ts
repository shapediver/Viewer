...
export class ParameterApi<T> implements IParameterApi<T> {
	...
	public set displayname(value: string | undefined) {
		...
		this.#logger.debug(
			`ParameterApi.${scope}: ${scope} was set to ${this.#parameter.displayname}.`,
		);
	}
	...
	public set hidden(value: boolean) {
		...
		this.#logger.debug(
			`ParameterApi.${scope}: ${scope} was set to ${this.#parameter.hidden}.`,
		);
	}
	...
	public set order(value: number | undefined) {
		...
		this.#logger.debug(
			`ParameterApi.${scope}: ${scope} was set to ${this.#parameter.order}.`,
		);
	}
	...
	public set sessionValue(value: T | string) {
		...
		this.#logger.debug(
			`ParameterApi.${scope}: ${scope} was set to ${this.#parameter.value}.`,
		);
	}
	...
	public set tooltip(value: string | undefined) {
		...
		this.#logger.debug(
			`ParameterApi.${scope}: ${scope} was set to ${this.#parameter.tooltip}.`,
		);
	}
...
export const isParameterApi = (obj: unknown): obj is IParameterApi<unknown> =>
	obj instanceof ParameterApi;
