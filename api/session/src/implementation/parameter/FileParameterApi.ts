...
export class FileParameterApi
	extends ParameterApi<File | Blob | string>
	implements IFileParameterApi
{
	// #region Properties (2)
...
export const isFileParameterApi = (obj: unknown): obj is IFileParameterApi =>
	obj instanceof FileParameterApi;
