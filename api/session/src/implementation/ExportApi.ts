...
export class ExportApi implements IExportApi {
	...
	public set displayname(value: string | undefined) {
		...
		this.#logger.debug(
			`ExportApi.${scope}: ${scope} was updated to ${this.#export.displayname}.`,
		);
	}
	...
	public set hidden(value: boolean) {
		...
		this.#logger.debug(
			`ExportApi.${scope}: ${scope} was updated to ${this.#export.hidden}.`,
		);
	}
	...
	public set maxWaitTime(value: number) {
		...
		this.#logger.debug(
			`ExportApi.${scope}: ${scope} was updated to ${this.#export.maxWaitTime}.`,
		);
	}
	...
	public set order(value: number | undefined) {
		...
		this.#logger.debug(
			`ExportApi.${scope}: ${scope} was updated to ${this.#export.order}.`,
		);
	}
	...
	public set tooltip(value: string | undefined) {
		...
		this.#logger.debug(
			`ExportApi.${scope}: ${scope} was updated to ${this.#export.tooltip}.`,
		);
	}
...
export const isExportApi = (obj: unknown): obj is IExportApi =>
	obj instanceof ExportApi;
