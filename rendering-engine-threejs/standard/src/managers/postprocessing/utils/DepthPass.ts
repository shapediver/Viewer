import { Pass, RenderPass, Resolution } from "postprocessing";
import { Camera, Color, MeshDepthMaterial, NearestFilter, RGBADepthPacking, Scene, WebGLRenderTarget, WebGLRenderer } from "three";
...
export class DepthPass extends Pass {
    ...
    private _renderToScreen: any;
    public get renderToScreen(): any {
        return this._renderToScreen;
    }
    public set renderToScreen(value: any) {
	...
	render(renderer: WebGLRenderer, inputBuffer: any, outputBuffer: any, deltaTime: any, stencilTest: any) {

		const renderTarget = this.renderToScreen ? null : this.renderTarget;
		this.renderPass.render(renderer, inputBuffer, inputBuffer);
