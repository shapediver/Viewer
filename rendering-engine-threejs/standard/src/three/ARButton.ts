...
class ARButton {
	...
	static createButton( renderer: THREE.WebGLRenderer, sessionInit: any = {} ) {
		...
		function showStartAR( /*device*/ ) {
			...
			button.onclick = function () {
				...
				if ( currentSession === null ) {
					...
					(<any>navigator).xr.requestSession( 'immersive-ar', sessionInit ).then( onSessionStarted );
		...
		if ( 'xr' in navigator ) {
			...
			(<any>navigator).xr.isSessionSupported( 'immersive-ar' ).then( function ( supported: any ) {
