        ...
        for (let i = 0; i < this._content.materials.length; i++) {
            ...
            if (materialExtensions[GLTF_EXTENSIONS.SHAPEDIVER_MATERIALS_PRESET]) {
                ...
                promises.push(
                    new Promise(async resolve => {
                        ...
                        materialData.color = this._converter.toHexColor(materialPreset.color);
            ...
            if (materialExtensions[GLTF_EXTENSIONS.KHR_MATERIALS_PBRSPECULARGLOSSINESS]) {
                ...
                if (pbrSpecularGlossiness.diffuseFactor !== undefined) {
                    specularGlossinessMaterialDataProperties.color = this._converter.toHexColor([pbrSpecularGlossiness.diffuseFactor[0] * 255, pbrSpecularGlossiness.diffuseFactor[1] * 255, pbrSpecularGlossiness.diffuseFactor[2] * 255]);
                ...
                if (pbrSpecularGlossiness.specularFactor !== undefined) {
                    specularGlossinessMaterialDataProperties.specular = this._converter.toHexColor([pbrSpecularGlossiness.specularFactor[0] * 255, pbrSpecularGlossiness.specularFactor[1] * 255, pbrSpecularGlossiness.specularFactor[2] * 255]);
                }
                ...
                if (material.pbrMetallicRoughness !== undefined) {
                    if (material.pbrMetallicRoughness.baseColorFactor !== undefined) {
                        unlitMaterialDataProperties.color = this._converter.toHexColor([material.pbrMetallicRoughness.baseColorFactor[0] * 255, material.pbrMetallicRoughness.baseColorFactor[1] * 255, material.pbrMetallicRoughness.baseColorFactor[2] * 255]);
                ...
                if (material.pbrMetallicRoughness !== undefined) {
                    ...
                    if (material.pbrMetallicRoughness.baseColorFactor !== undefined) {
                        standardMaterialDataProperties.color = this._converter.toHexColor([material.pbrMetallicRoughness.baseColorFactor[0] * 255, material.pbrMetallicRoughness.baseColorFactor[1] * 255, material.pbrMetallicRoughness.baseColorFactor[2] * 255]);
            ...
            if (material.emissiveFactor !== undefined) {
                materialDataProperties.emissiveness = this._converter.toHexColor([material.emissiveFactor[0] * 255, material.emissiveFactor[1] * 255, material.emissiveFactor[2] * 255]);
            }
            ...
            if (materialExtensions[GLTF_EXTENSIONS.KHR_MATERIALS_VOLUME]) {
                ...
                if (volumeExtension.attenuationColor !== undefined) {
                    standardMaterialDataProperties.attenuationColor = this._converter.toHexColor([volumeExtension.attenuationColor[0] * 255, volumeExtension.attenuationColor[1] * 255, volumeExtension.attenuationColor[2] * 255]);
                }
            }
            ...
            if (materialExtensions[GLTF_EXTENSIONS.KHR_MATERIALS_SHEEN]) {
                ...
                if (sheenExtension.sheenColorFactor !== undefined) {
                    standardMaterialDataProperties.sheenColor = this._converter.toHexColor([sheenExtension.sheenColorFactor[0] * 255, sheenExtension.sheenColorFactor[1] * 255, sheenExtension.sheenColorFactor[2] * 255]);
                }
            ...
            if (materialExtensions[GLTF_EXTENSIONS.KHR_MATERIALS_SPECULAR]) {
                ...
                if (specularExtension.specularColorFactor !== undefined) {
                    standardMaterialDataProperties.specularColor = this._converter.toHexColor([specularExtension.specularColorFactor[0] * 255, specularExtension.specularColorFactor[1] * 255, specularExtension.specularColorFactor[2] * 255]);
                }
