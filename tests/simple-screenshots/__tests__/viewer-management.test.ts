...
for(let c = 0; c < allCapabilities.length; c++) {
    ...
    if(process.env.PORT !== 'browserstack') {
        ...
        name = 'viewer_closing ' + ((allCapabilities[c] as DesktopCapabilities).os ? 
    ...
    describe('device testing', () => {
        ...
        test(name, async () => {
            ...
            await screenshotCompare(await driver.takeScreenshot(), name + '_1');
            ...
            await screenshotCompare(await driver.takeScreenshot(), name + '_2');
            ...
            await screenshotCompare(await driver.takeScreenshot(), name + '_3');
        });
    });
}
