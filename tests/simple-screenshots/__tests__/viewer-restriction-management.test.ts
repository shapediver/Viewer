    ...
    describe('device testing', () => {
        ...
        test(name, async () => {
            await driver.executeAsyncScript(async (cb: any) => {
                ...
                let session1 = await api.createSession({ excludeViewers: ['myViewer'], id: 'mySession1', ticket: 'a7a468be421d49eeede903037db71fadbcc9df95919b088e497ef32c4e3d4934a9c0f866997c915f40f4bbb432119fc838c44d89061a64185f6ca8b02125c0d36aa3b1c43951fe0800ec5d367ec2618351a3dbfbac642b23b3593693c8fce19a89122037938d2eb614fcdc2bc50c0dffd01ef2b9718c-69dd449456f08051ab79a42a4cbc9881', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
