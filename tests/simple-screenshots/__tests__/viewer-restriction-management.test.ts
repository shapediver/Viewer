    ...
    describe('device testing', () => {
        ...
        test(name, async () => {
            await driver.executeAsyncScript(async (cb: any) => {
                ...
                let session1 = await api.createAndInitializeSession({ excludeViewers: ['myViewer'], id: 'mySession1', ticket: 'affa36eb1031f3cd6175477dc4d76b785e2ca1c6a70c36adabc1d9547c11660a2957f4ba5e4f55a16225af626c2f25be90d944d355938fd35fc03daaaf9c56cbc85f0c6c7325aeb956145b3a030ad4aa217eefaf2d977b2815aefec5e87912ea1b731507ff24f9109cf74b0aa0eebcea9b9e7b3c807a-8b9959c9e647a0d633136750b78fbf61', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
