    ...
    describe('device testing', () => {
        ...
        test(name, async () => {
            ...
            await driver.executeAsyncScript(async (cb: any) => {
                ...
                let session = await api.createAndInitializeSession({ ticket: 'e479c043c7907965e28c5bc422aad1827cbb9a77dde01c72b62b6d9ca8d7d211a9f74ac6c53c21a6029cb1ebc828605721c6bad4734ede24a3a66bc6d60ba8ab39da0a500539e3e182e527df7f8c1c599b2400cdf620168213460239a3034f8dd00f9a4d9cd42dc7b9665b20a4f6e8af51f102a0d414746deeead0984327c9-435d1f500d1f04b76ac49fa7cab2cf4d', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
        ...
        test(name, async () => {
            ...
            await driver.executeAsyncScript(async (cb: any) => {
                const api: typeof API = (<any>window).api; 
                let viewer = await api.createAndInitializeViewer({id: 'myViewer', canvas: <HTMLCanvasElement>document.getElementById('canvas')})
                let session = await api.createAndInitializeSession({ ticket: '3a5d1cb085437aafeafa44dceedb09417b5c82bccfd355f12cf23abc5546b7f697dd7b150b7abd5ee1288e4ef31dc67b7498a6459babaeae4f63ca39afff6b72235052ba0728f785dd36dc55569a0846df3d8162fc29bffbad9fdc0204f7b43c36ca7c7eb44d4ce67a62000ec68bac4c0960c0e360f06ea82b600f895deb6f-ce913db01b16300d5112a5a484cc56a6', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
        ...
        test(name, async () => {
            ...
            await driver.executeAsyncScript(async (cb: any) => {
                const api: typeof API = (<any>window).api; 
                let viewer = await api.createAndInitializeViewer({id: 'myViewer', canvas: <HTMLCanvasElement>document.getElementById('canvas')})
                let session = await api.createAndInitializeSession({ ticket: '1b140110fb009946286d9706db7b576bba76894025ac57b1d3aad48cd34eb58757975053ff1ea08c4cb8dd8b0bf1b526507b981edaf5bf4bf1bdeaec7824f83c2bfb29a21487304eb1a34936d9eb1dc1e90aa45c886b07b1eac73804a021c19e09a1ba52b3217d26d6c191f10090ffef3c46b8eeafa83f2a8b1cfe7a10bc87-978d3eb5e574310fe7d40741623f8a26', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
        ...
        test(name, async () => {
            ...
            await driver.executeAsyncScript(async (cb: any) => {
                const api: typeof API = (<any>window).api; 
                let viewer = await api.createAndInitializeViewer({id: 'myViewer', canvas: <HTMLCanvasElement>document.getElementById('canvas')})
                let session = await api.createAndInitializeSession({ ticket: '-a23d9dc0e103d57f8ccd89b6f1d1e951', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
        ...
        test(name, async () => {
            ...
            await driver.executeAsyncScript(async (cb: any) => {
                const api: typeof API = (<any>window).api; 
                let viewer = await api.createAndInitializeViewer({id: 'myViewer', canvas: <HTMLCanvasElement>document.getElementById('canvas')})
                let session = await api.createAndInitializeSession({ ticket: '-92b182e5dbe03bc50a6f4e1dabf27def', modelViewUrl: 'https://sdeuc1.eu-central-1.shapediver.com' });
