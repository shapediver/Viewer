...
export class PlaneRestriction extends AbstractRestriction implements IRestriction {
    ...
    constructor(viewport: IViewportApi, geometryMathManager: GeometryMathManager, parentNode: ITreeNode, id: string, settings: IVisualizationSettings, properties: PlaneRestrictionProperties) {
        ...
        this.#angularRestriction = new AngularRestriction(viewport, geometryMathManager, parentNode, this, settings, this.#properties.angularSnapRestriction);
        this.#axisRestriction = new AxisRestriction(viewport, geometryMathManager, parentNode, this, this.#properties.axisSnapRestriction);
