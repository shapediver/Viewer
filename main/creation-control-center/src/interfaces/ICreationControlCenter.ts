...
export interface ICreationControlCenter {
  ...
  applyViewportSettings(viewportId: string, settings: ISettingsV3_4, sections?: { ar?: boolean | undefined; scene?: boolean | undefined; camera?: boolean | undefined; light?: boolean | undefined; environment?: boolean | undefined; general?: boolean | undefined; }): Promise<void>;
  ...
  getViewportSettings(viewportId: string): ISettingsV3_4;
