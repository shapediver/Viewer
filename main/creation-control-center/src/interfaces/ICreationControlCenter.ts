...
export interface ICreationControlCenter {
    ...
    /**
      ...
      * @returns 
      */
    createSession(properties: { ticket: string, modelViewUrl: string, bearerToken?: string, primarySession?: boolean, id?: string, excludeViewers?: string[], waitForOutputs?: boolean, loadOutputs?: boolean, initialParameters?: { [key: string]: string } }): Promise<any>;
     ...
     * @returns 
     */
    createViewer(properties?: { visibility?: VISIBILITY_MODE, canvas?: HTMLCanvasElement, id?: string, branding?: { logo?: string | null, backgroundColor?: string } }): Promise<any>;
